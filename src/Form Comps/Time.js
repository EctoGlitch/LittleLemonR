...
const TimeSelector = ({ label, name, touched, error }) => {
  ...
  const CustomDateInput = forwardRef(({ value, onClick }, ref) => (
    <div className="relative">
      <input
        type="text"
        className='h-[80px] w-full relative text-black font-p p-6 rounded-4xl focus:outline-none focus:ring-2 focus:ring-yellow-500'
        onClick={onClick}
        ref={ref}
        value={value}
        readOnly
